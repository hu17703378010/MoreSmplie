...
{
    [SVProgressHUD show];
    NSString *str =[NSString stringWithFormat: @"<TABLE height = 50 cellPadding = 4 width = %f align = center background =010101  border = 1 table> <TBODY> <TR> <TD> <p align = center> <FONT face = 隶书 size = 4>%@",kScreenWidth - 20*KW,self.model.Title];
    NSString *str2 = [NSString stringWithFormat:@"%@</TD></TR></TABLE>%@<p align = right>---素材来自网络</p>",str, self.model.Content];
    NSString *string2 = [NSString stringWithFormat:@".jpg\" width = ""%f""",kScreenWidth - 20*KW];
    NSString *str1 = [str2 stringByReplacingOccurrencesOfString:@".jpg\"" withString:string2];
